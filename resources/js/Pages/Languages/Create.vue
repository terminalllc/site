        ...
        <div class="max-w-3xl bg-white rounded shadow overflow-hidden">
            ...
            <form @submit.prevent="submit">
                <div class="flex flex-wrap -mb-8 -mr-6 p-8">
                    ...
                    <text-input v-model.trim="form.encoding" :error="form.errors.encoding"
                        class-div="lg:w-1/2" label="Encoding" />
                    <div class="items-center mb-6 pb-8 pr-6 w-1/2">
                        <label class="form-label">Default?: </label>
                        <input v-model="form.is_default" :true-value="1" :false-value="0" class="mr-2 pl-6 w-6 h-6" type="checkbox" />
                    </div>
                    <div class="items-center mb-6 pb-8 pr-6 w-1/2">
