            ...
            <table class="whitespace-no-wrap w-full">
                ...
                <tr v-for="(language, index) in languages.data" :key="language.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                    ...
                    <td class="flex justify-end py-2 border-t">
                        <Link class="px-2" :href="this.$route('languages.edit', language.id)" tabindex="-1" title="Змінити">
                        <icon name="pencil-square" class="block text-green-600" />
                        </Link>
                        <button title="Видалити" class="px-2" @click.prevent="showModal(language.id)">
