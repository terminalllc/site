                ...
                <div class="header-top-wrap">
                    <div class="header-catalog-mobile">
                        <button class="header-catalog-btn btn-menu--js">
                            <span class="header-catalog-btn-icon">
                                <img onclick="openMenu();" class="logo" src="/images/icons/icon-burger-catalog.svg"
                                    alt="menu">
                            </span>
                        </button>
                    </div>
                    <div class="header-logo">
                        <div class="header-logo-item">
                            <a href="{{localized_route('home',[], App::getLocale())}}">
                    ...
                    <div class="header-right">
                        <div class="header-lang">
                            ...
                            <a href="{{localized_route($current_route, [], $lang->code)}}" @class([ 'active'=> App::getLocale()
